...
const BRANCHES = [
  ...
  {
    id: 11,
    name: 'MMOCCUL Kribi Branch',
    address: 'Kribi Town Center, Kribi, Cameroon',
    phone: '+237 670 020 630',
    hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 9:00 AM - 1:00 PM',
    coordinates: { lat: 2.9389, lng: 9.9086 },
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=2.9389,9.9086',
    type: 'Branch',
  },
  {
    id: 12,
    name: 'MMOCCUL Mmockmbie Branch',
  ...
  {
    id: 13,
    name: 'MMOCCUL Kumba Branch',
    address: 'Kumba Town Center, Kumba, Cameroon',
    phone: '+237 670 020 630',
    hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 9:00 AM - 1:00 PM',
    coordinates: { lat: 4.6364, lng: 9.4463 },
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=4.6364,9.4463',
    type: 'Branch',
  },
];
