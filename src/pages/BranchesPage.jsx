...
const branchList = [
    ...
    },
    {
      ...
      phone: '+237 670 020 630',
      hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 8:00 AM - 12:00 PM',
    ...
    {
      id: 11, name: 'MMOCCUL Kribi Branch',
      address: 'Kribi Town Center, Kribi, Cameroon',
      phone: '+237 670 020 630',
      hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 8:00 AM - 12:00 PM',
      region: 'South Region', type: 'Branch',
      services: ['Personal Banking', 'Business Banking', 'Savings', 'Loans'],
      image: branchImage5,
      features: ['WiFi', 'Parking', 'ATM'],
      manager: 'Jean-Claude Mbarga',
      established: '2020'
    },
    {
      id: 12, name: 'MMOCCUL Mmockmbie Branch',
      address: 'Mmockmbie Quarter, Yaoundé, Cameroon',
      phone: '+237 670 020 630',
      hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 8:00 AM - 12:00 PM',
      region: 'Yaoundé', type: 'Branch',
      services: ['Personal Banking', 'Savings', 'Mobile Banking', 'Microfinance'],
      image: branchImage2,
      features: ['WiFi', 'ATM', 'Parking'],
      manager: 'Sophie Ngo Nyobe',
      established: '2019'
    },
    {
      id: 13, name: 'MMOCCUL Kumba Branch',
      address: 'Kumba Town Center, Kumba, Cameroon',
      phone: '+237 670 020 630',
      hours: 'Mon-Fri: 8:00 AM - 4:30 PM, Sat: 8:00 AM - 12:00 PM',
      region: 'Southwest Region', type: 'Branch',
      services: ['Personal Banking', 'Business Banking', 'Agricultural Loans', 'Microfinance'],
...
export const BranchesPage = () => {
  ...
  const regions = ['All', 'Yaoundé', 'Douala', 'West Region', 'Southwest Region', 'Northwest Region', 'East Region', 'South Region']
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <div className="flex items-center gap-3 rounded-full bg-white/10 px-5 py-2.5 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">13+ Strategic Locations</span>
            </div>
            <div className="flex items-center gap-3 rounded-full bg-white/10 px-5 py-2.5 backdrop-blur-sm">
